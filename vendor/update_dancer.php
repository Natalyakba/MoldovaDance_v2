...
mysqli_query($connect, "UPDATE `dancers` SET `name_dancer` = '$name_dancer', `city_dancer` = '$id_city', `photo_dancer` = '$photo_dancer', 
`link_dancer` = '$link_dancer', `about_dancer` = '$about_dancer' WHERE `dancers`.`id_dancer` = '$id_dancer'");
